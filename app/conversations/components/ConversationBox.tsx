...
const ConversationBox = ({
  ...
  return (
    <div
      onClick={handleClick}
      className={clsx(
        `w-full relative flex items-center gap-2.5 py-4 px-5 border-b border-b-[#242424] hover:bg-[#1a1a1a] transition cursor-pointer group`,
        selected ? "bg-[#1e1e1e]" : "bg-transparent",
      )}
    >
      {data.isGroup ? (
      ...
      <div className="flex-1 min-w-0">
        <div className="focus:outline-none">
          ...
          <p
            className={clsx(
              `truncate text-sm`,
              hasSeen ? "text-gray-300" : "text-gray-100 font-medium",
            )}
          >
            {lastMessageText}
          </p>
